...
$usluga13 = $result3->fetch_assoc();
$sql4 = "SELECT * from uslugi WHERE id =4";
$result4 = $mysqli->query($sql4);
$usluga14 = $result4->fetch_assoc();
$mysqli->close();
    ...
    <div class="navbar__container">
        ...
        <ul class="navbar__menu">
            ...
            <li class="navbar__btn">
                <a href="logoutadmin.php" class="button" id="signup">Wyloguj się</a>
...
<div class="hero" id="home">
    <div class="hero__container">
        <h1 class="hero__heading">Panel <span>Admina</span></h1>
        <p class="hero__description">Urodex</p>
